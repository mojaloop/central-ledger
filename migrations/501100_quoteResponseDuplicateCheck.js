...
exports.up = (knex, Promise) => {
  return knex.schema.hasTable('quoteResponseDuplicateCheck').then((exists) => {
    if (!exists) {
      return knex.schema.createTable('quoteResponseDuplicateCheck', (t) => {
        t.bigIncrements('quoteResponseId').primary().unsigned().comment('The response to the intial quote')
...
exports.down = (knex, Promise) => {
  return knex.schema.dropTableIfExists('quoteResponseDuplicateCheck')
}
