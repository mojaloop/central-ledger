...
exports.up = (knex, Promise) => {
  return knex.schema.hasTable('quoteError').then((exists) => {
    if (!exists) {
      return knex.schema.createTable('quoteError', (t) => {
        t.bigIncrements('quoteErrorId').primary().notNullable()
        ...
        t.bigInteger('quoteResponseId').unsigned().defaultTo(null).nullable().comment('The response to the intial quote')
