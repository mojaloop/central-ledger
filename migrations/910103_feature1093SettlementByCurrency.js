...
exports.down = async (knex, Promise) => {
  await knex.schema.dropTableIfExists('ledgerAccountType')
  await knex.schema.dropTableIfExists('ledgerEntryType')
  await knex.schema.dropTableIfExists('settlement')
  return 0
}
