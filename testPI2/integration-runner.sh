...
if [ $# -ne 1 ]; then
    ...
    echo " - DB_HOST: Posgres host name"
    echo " - DB_PORT: Posgres container port"
    echo " - DB_NAME: Posgres database"
    echo " - DB_IMAGE: Docker Image for DB"
    echo " - DB_TAG: Docker tag/version for DB"
