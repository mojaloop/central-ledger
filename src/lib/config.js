...
module.exports = {
  ...
  ENABLED_SETTLEMENT_MODEL_RULES_ENGINE: RC.ENABLED_SETTLEMENT_MODEL_RULES_ENGINE,
  ...
  INCLUDE_DECODED_TRANSACTION_OBJECT: RC.INCLUDE_DECODED_TRANSACTION_OBJECT || false
}
