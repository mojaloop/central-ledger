...
module.exports = {
  ...
  TOPICS_TEMPLATE_TRANSFER_PREPARE_TEMPLATE: RC.TOPICS_TEMPLATE.TRANSFER.PREPARE.TEMPLATE,
  KAFKA_CONSUMER_CONFIG_OPTIONS: RC.KAFKA.CONSUMER.CONFIG.OPTIONS,
  KAFKA_CONSUMER_CONFIG_RDKAFKACONF: RC.KAFKA.CONSUMER.CONFIG.RDKAFKACONF,
  DFSPS: RC.DFSPS
}
