...
const prepare = async (message, stateReason = null, hasPassedValidation = true) => {
  ...
  try {
    const result = await TransferFacade.saveTransferPrepared(message, stateReason, hasPassedValidation)
