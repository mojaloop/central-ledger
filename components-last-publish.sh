...
output_file="components-last-publish.csv"
...
echo "type,bom_ref,group,name,version,description,algorithm,hash_text,license_id,purl,website,issueTracker,vcs,publish_details" >> "$output_file"
