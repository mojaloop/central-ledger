...
shutdown_and_remove() {
  docker-compose -p centralleader -f $docker_compose_file -f $docker_functional_compose_file stop
}
...
docker-compose -p centralleader -f $docker_compose_file -f $docker_functional_compose_file up -d postgres
...
docker-compose -p centralleader -f $docker_compose_file -f $docker_functional_compose_file up -d central-ledger
...
docker-compose -p centralleader -f $docker_compose_file -f $docker_functional_compose_file up -d central-ledger-admin
