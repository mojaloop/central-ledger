...
const Model = require('../../../src/seeds/transferParticipantRoleType')

Test('Transfer participant role type', async (transferParticipantRoleTypeTest) => {
  let sandbox

  transferParticipantRoleTypeTest.beforeEach(t => {
    sandbox = Sinon.createSandbox()
    t.end()
  })

  transferParticipantRoleTypeTest.afterEach(t => {
    sandbox.restore()
    t.end()
  })
  ...
  await transferParticipantRoleTypeTest.test('seed should', async (test) => {
    ...
    try {
      ...
      test.ok(knexStub.withArgs('transferParticipantRoleType').calledOnce, 'knex called with transferParticipantRoleType once')
      test.end()
    } catch (err) {
