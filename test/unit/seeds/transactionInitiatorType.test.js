...
const Model = require('../../../src/seeds/transactionInitiatorType')

Test('TransactionInitiatorType', async (transactionInitiatorTypeTest) => {
  let sandbox

  transactionInitiatorTypeTest.beforeEach(t => {
    sandbox = Sinon.createSandbox()
    t.end()
  })

  transactionInitiatorTypeTest.afterEach(t => {
    sandbox.restore()
    t.end()
  })
  ...
  await transactionInitiatorTypeTest.test('seed should', async (test) => {
    ...
    try {
      ...
      test.ok(knexStub.withArgs('transactionInitiatorType').calledOnce, 'knex called with transactionInitiatorType once')
      test.end()
    } catch (err) {
  ...
  await transactionInitiatorTypeTest.end()
})
