...
Test('Extension model', async (extensionModelTest) => {
  ...
  await extensionModelTest.test('get extensions by transferId with empty id', async (assert) => {
    Db.transferExtension.find.withArgs({ transferId: null, isFulfilment: false }).throws(new Error())
    try {
  ...
  await extensionModelTest.test('get extension by transferId', async (assert) => {
    Db.transferExtension.find.withArgs({ transferId: 1, isFulfilment: false }).returns(transferExtensionModelFixtures[0])
    try {
  ...
  await extensionModelTest.test('get fulfilment extension by transferId', async (assert) => {
    ...
    Db.transferExtension.find.withArgs({ transferId: 1, isFulfilment }).returns(transferExtensionModelFixtures[0])
    try {
