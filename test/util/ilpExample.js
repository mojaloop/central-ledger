...
const l1pGeneratedFulfilment = caluclateFulfil(l1pPacket, l1pSecret)

const l1pProvidedFulfilment = 'fEGpcud1ZXZDCyTIkJjf4P5TEW80R0igI72nMAg9dE8'
...
const l1pProvidedCondition = 'mEw-mqZdYOnuzv4oOVbd9yCXZ5b6xcfO5lUvfpec1KY'

const l1pGeneratedCondition = calculateConditionFromFulfil(l1pGeneratedFulfilment)
...
const validateFulfilCondition = (fulfilment, condition) => {
  // TODO: The following hashing code should be moved into a re-usable common-shared-service at a later point
  const calculatedCondition = calculateConditionFromFulfil(fulfilment)
...
// // // swagger example
const con = 'GRzLaTP7DJ9t4P-a_BA0WA9wzzlsugf00-Tn6kESAfM'
const ful = 'UNlJ98hZTY_dsw0cAqw4i_UN3v4utt7CZFB4yfLbVFA'
