...
do
  ...
  sh -c "curl -X POST \
    ...
    \"value\": \"http://localhost:${MOCK_SIM_PORT}/${FSP}/transfers\"
  }'"
  ...
  sh -c "curl -X POST \
    ...
    \"value\": \"http://localhost:${MOCK_SIM_PORT}/fsp/${FSP}/participants/{{partyIdType}}/{{partyIdentifier}}\"
  }'"
  ...
  sh -c "curl -X POST \
    ...
    \"value\": \"http://localhost:${MOCK_SIM_PORT}/fsp/${FSP}/parties/{{partyIdType}}/{{partyIdentifier}}\"
  }'"
  ...
  sh -c "curl -X POST \
    ...
    \"value\": \"http://localhost:${MOCK_SIM_PORT}/fsp/${FSP}/participants/{{partyIdType}}/{{partyIdentifier}}/error\"
  }'"
  ...
  sh -c "curl -X POST \
    ...
    \"value\": \"http://localhost:${MOCK_SIM_PORT}/fsp/${FSP}/participants/{{requestId}}\"
  }'"
  ...
  sh -c "curl -X POST \
    ...
    \"value\": \"http://localhost:${MOCK_SIM_PORT}/fsp/${FSP}\/participants/{{requestId}}/error\"
   }'"
  ...
  sh -c "curl -X POST \
    ...
    \"value\": \"http://localhost:${MOCK_SIM_PORT}/${FSP}/transfers/{{transferId}}\"
  }'"
  ...
  sh -c "curl -X POST \
    ...
    \"value\": \"http://localhost:${MOCK_SIM_PORT}/${FSP}/transfers/{{transferId}}/error\"
  }'"
  ...
  sh -c "curl -X POST \
    ...
    \"value\": \"http://localhost:${MOCK_SIM_PORT}/${FSP}/bulkTransfers\"
  }'"
  ...
  sh -c "curl -X POST \
    ...
    \"value\": \"http://localhost:${MOCK_SIM_PORT}/${FSP}/bulkTransfers/{{id}}\"
  }'"
  ...
  sh -c "curl -X POST \
    ...
    \"value\": \"http://localhost:${MOCK_SIM_PORT}/${FSP}/bulkTransfers/{{id}}/error\"
  }'"
  ...
  sh -c "curl -X POST \
    ...
    \"value\": \"http://localhost:${MOCK_SIM_PORT}/${FSP}\"
  }'"
