...
echo "=> EXPECTED RESULT: Nothing changed. Showing same 4 records."
echo
echo
...
echo "EXPECTED RESULT: Transfer is aborted and a transferFulfilment record is inserted. Showing 4 records (previously 3)."
echo
echo
...
echo "=> EXPECTED RESULT: Not changed. Showing same 8 records."
echo
echo
...
echo "=> EXPECTED RESULT: Not changed. Showing same 12 records."
echo
echo
...
echo "=> EXPECTED RESULT: Transfer state changed to ABORTED. Showing 16 records (previously 14)."
echo
echo
...
ON p.participantId = pc.participantId
ORDER BY 1 DESC"
echo "=> EXPECTED RESULT: dfsp1-SETTLEMENT account balance is unchanged at -80, Hub-HUB_RECONCILIATION is reverted back to 80."
echo
echo
...
ORDER BY 1 DESC"
echo "=> EXPECTED RESULT: DR is reverted back during 12-ABORTED, thus Hub-HUB_RECONCILIATION account balance is 80 (32:30). Showing 8 records (previously 7)."
echo
echo
