...
echo "---------------------------------------------------------------------"
echo "RecordFundsOut PREPARE & RESERVE 50"
echo "---------------------------------------------------------------------"

echo "Sending request for prepare and reserve 50 USD from dfsp1 settlement account"
sh -c "curl -X POST \
  ...
  -d '{
    \"transferId\": \"523ec634-ef48-6575-a6a0-ded2955b8104\",
...
echo
echo
echo "Completed Scenario 11-5 - Reconciliation transfer prepare & reserve (recordFundsOutPrepareReserve)"
echo
