...
const StateChangeModel = require('../../../dist/models/transfer/transferStateChange')
const TransferExtensionModel = require('../../../dist/models/transfer/transferExtension')
const IlpModel = require('../../../dist/models/transfer/ilpPacket')
const TransferFacade = require('../../../dist/models/transfer/facade')
const TransferFulfilmentDuplicateCheckModel = require('../../../dist/models/transfer/transferFulfilmentDuplicateCheck')
const TransferFulfilmentModel = require('../../../dist/models/transfer/transferFulfilment')
const TransferParticipantModel = require('../../../dist/models/transfer/transferParticipant')
...
exports.prepareData = async () => {
  try {
    ...
    await TransferParticipantModel.saveTransferParticipant({
      transferId: transferResult.transfer.transferId,
      participantId: transferDuplicateCheckResult.participantPayerResult.participant.participantId,
