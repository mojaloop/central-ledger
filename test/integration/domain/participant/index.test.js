...
Test('Participant service', async (participantTest) => {
  ...
  await participantTest.test('add participant endpoint', async (assert) => {
    try {
      ...
      await ParticipantEndpointHelper.prepareData(participant.name, Enum.FspEndpointTypes.FSPIOP_CALLBACK_URL_FX_QUOTES, `${testData.endpointBase}`)
      await ParticipantEndpointHelper.prepareData(participant.name, Enum.FspEndpointTypes.FSPIOP_CALLBACK_URL_FX_TRANSFER_POST, `${testData.endpointBase}/fxTransfers`)
      await ParticipantEndpointHelper.prepareData(participant.name, Enum.FspEndpointTypes.FSPIOP_CALLBACK_URL_FX_TRANSFER_PUT, `${testData.endpointBase}/fxTransfers/{{commitRequestId}}`)
      await ParticipantEndpointHelper.prepareData(participant.name, Enum.FspEndpointTypes.FSPIOP_CALLBACK_URL_FX_TRANSFER_ERROR, `${testData.endpointBase}/fxTransfers/{{commitRequestId}}/error`)
      ...
      await ParticipantEndpointHelper.prepareData(participant.name, Enum.FspEndpointTypes.FSPIOP_CALLBACK_URL_FX_TRANSFER_POST, `${testData.endpointBase}/fxTransfers`)
      await ParticipantEndpointHelper.prepareData(participant.name, Enum.FspEndpointTypes.FSPIOP_CALLBACK_URL_FX_TRANSFER_PUT, `${testData.endpointBase}/fxTransfers/{{commitRequestId}}`)
      await ParticipantEndpointHelper.prepareData(participant.name, Enum.Enum.FspEndpointTypes.FSPIOP_CALLBACK_URL_FX_TRANSFER_ERROR, `${testData.endpointBase}/fxTransfers/{{commitRequestId}}/error`)
      assert.end()
    } catch (err) {
      console.log(err)
